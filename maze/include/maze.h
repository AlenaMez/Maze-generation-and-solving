...
public:
    ...
    void load(std::string _filename)
    {
      ...
      else im = cv::imread("/home/ecn/Documents/ecn_arpro/maze/mazes/"+filename, cv::IMREAD_GRAYSCALE);
    ...
    void save()
    {
        cv::imwrite("/home/ecn/Documents/ecn_arpro/maze/mazes/maze.png", im);
        display("Maze", im);
    }
    ...
    void saveSolution(std::string suffix)
    {
        ...
        cv::imwrite("/home/ecn/Documents/ecn_arpro/maze/mazes/" + name, out);
